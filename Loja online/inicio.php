    ...
    <tr>
        ...
        <td style="width: 10%;">
            <button type="button" class="btn_topo" onclick="window.location.href='inicio.php'" >
                <img src="../Imagens/Logo2.png" style=" height: 110px; border-radius: 10px; margin-left: 50px; ">
            </button>
        </td>
        <!-- =================================================
            CATEGORIAS
        ...
        <td style="width: 75%;" align="center">
            <div style="margin: 0;">
                <div
                    ...
                    <!-- PROMOÇÕES -->
                    <div class="btn">
                        <button type="button" onclick="alterar_categoria('promocoes')">
                    ...
                    <!-- QUEIJOS -->
                    <div class="btn">
                        <button type="button" onclick="alterar_categoria('queijos')">
                    ...
                    <!-- DEFUMADOS -->
                    <div class="btn">
                        <button type="button" onclick="alterar_categoria('defumados')" >
                    ...
                    <!-- DOCES -->
                    <div class="btn">
                        <button type="button" onclick="alterar_categoria('doces')">
                    ...
                    <!-- BEBIDAS -->
                    <div class="btn">
                        <button type="button" onclick="alterar_categoria('bebidas')" >
        ...
        ================================================== -->
        <td>
            <button type="button" class="btn_topo" onclick="alterar_div()" style=" margin-bottom: 20px; margin-right: 40px; ">
        ...
        ================================================== -->
        <td style="width: 5%;">
            <button type="button" class="btn_topo" onclick="window.location.href='login/Cliente.html'" style=" margin-bottom: 20px; margin-right: 80px; " >
                <img id="cliente" src="../Imagens/Cliente.png" style=" height: 40px; width: 40px; " >
                <label>login</label>
            </button>
        </td>
    </tr>
...
<div class="produtos_categorias_carrinho">
    ...
    <div class="produtos_categorias">
        ...
        <!-- =================================================
             CARROSSEL
        ================================================== -->
        <div id="centro" style=" height: auto; min-height: 90px; " >
            <div id="centro">
            ...
            <div class="carrinho-container">
                <?php if (!empty($itens)) { ?>
                    <?php foreach ($itens as $key => $value) { ?>
                        <div class="produto">
                            <!-- IMAGEM -->
                            <img src="../Produtos/<?php echo htmlspecialchars($value['imagem']); ?>" style=" height: 200px; width: 220px; object-fit: contain; " alt="<?php echo htmlspecialchars($value['nome']); ?>" >
                            <br>
                            <!-- NOME -->
                            <strong>
                            ...
                            <br>
                            <!-- ADICIONAR -->
                            <a href="?adicionar=<?php echo $key; ?><?php echo $categoria !== '' ? '&categoria=' . urlencode($categoria) : ''; ?>" >
...
window.addEventListener(
    "DOMContentLoaded",
    function () {
        const area = document.querySelector( ".produtos_categorias_carrinho" );
        const estado = localStorage.getItem( "carrinhoAberto" );
        if (estado === "true") {
            area.classList.add("carrinho_aberto");
        } else {
            area.classList.remove("carrinho_aberto");
...
function alterar_categoria(categoria) {
    let url = "inicio.php?categoria=" + encodeURIComponent(categoria);
    window.location.href = url;
}
</script>
</body>
